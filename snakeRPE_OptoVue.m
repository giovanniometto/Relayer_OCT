function [RPE] = snakeRPE_OptoVue(im,RPEguess)
...
Options.Sigma1=round(2); 
Options.Sigma2=round(3);
Options.Wedge=20; %10

Options.Alpha= .5;  
Options.Beta= 8.2^4; % 10^4;
Options.Kappa=.4;
